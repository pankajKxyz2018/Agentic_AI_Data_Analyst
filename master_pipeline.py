# ============================================================
#  master_pipeline.py  —  1 Click Data Analysis
#  v12 — 1 Click Data Analysis
#  © 2024 Pankaj Kumar Das — 1clickdataanalysis.com
...
# ─── Page Config ──────────────────────────────────────────────────────────────
st.set_page_config(page_title="1 Click Data Analysis", page_icon="📊",
...
def generate_pdf_report(df, found, domain):
    try:
        ...
        story += [
            ...
            Paragraph("1 Click Data Analysis", title_s),
        ...
        story += [
            ...
            Paragraph(f"Generated by 1 Click Data Analysis  ·  {now}  ·  Domain: {domain}", sub_s)]
